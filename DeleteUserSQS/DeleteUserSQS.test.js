...
//Test function for DeleteUserSQS.js
...
const main = require(`./DeleteUserSQS`);  
const Master = require('./MasterClass').handler;
let master = new Master();
let event = require("./__data__/event").event;
...
describe(`Remediate a User`, () => {

    // test calls ************* CHANGE *************
    test(`Testing CreateUser going through SQS event`, async() => {
        await remediationTest('deleteUser');
    });
});

//test function
async function remediationTest(functionName) {
    ...
    await main.setFunction('deleteLoginProfile', (params) => {

        return {promise: () => {} }
    });

    await main.setFunction('deleteMessage', (params) => {

        return {promise: () => {} }
    });

    await main.setSQS((params) => {

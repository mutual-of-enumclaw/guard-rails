...
//Test function for RemediatePolicies.js
...
const main = require(`./RemediatePolicies`);  // ******** CHANGE ********* main file name 
...
describe(`Remediate Policies`, () => {

    //test calls 
    test(`Testing CreatePolicy event`, async() => {
        await remediationTest(getEvent('snd', "console", 'CreatePolicy'), "deletePolicy");
    });
    // test(`Testing DeletePolicy event`, async() => {
    //     path.n = 'Path: '
    //     await remediationTest(getEvent('snd', "console", 'DeletePolicy'), 'deletePolicy');
    // });
    // test(`Testing CreatePolicyVersion event`, async() => {
    //     path.n = 'Path: '
    //     await remediationTest(getEvent('snd', "console", 'CreatePolicyVersion'), 'deletePolicyVersion');
    // });
    // test(`Testing SetDefaultPolicyVersion event`, async() => {
    //     path.n = 'Path: '
    //     await remediationTest(getEvent('snd', "console", 'SetDefaultPolicyVersion'), 'setDefaultPolicyVersion');
    // });
    // test(`Testing DeletePolicyVersion event`, async() => {
    //     path.n = 'Path: '
    //     await remediationTest(getEvent('snd', "console", 'DeletePolicyVersion'), 'deletePolicyVersion');
    // });
});
...
async function remediationTest(event, functionName) {
    ...
    await main.setFunction('setDefaultPolicyVersion', (params) => {
            return {promise: () => {} }
    });
